...
<section class="content-header">
  <h1>
    ...
    <?php } else {?>
      <a href="<?php echo ADMIN; ?>/order/change?id=<?php echo $order['id']?>&status=0" class="btn btn-default btn-xs">Вернуть на доработку</a>
    <?php } ?>
    <a href="<?php echo ADMIN; ?>/order/delete?id=<?php echo $order['id']?>" class="btn btn-danger btn-xs delete">Удалить</a>
  </h1>
  <ol class="breadcrumb">
