...
class Order extends AppModel
{
  ...
  public static function mailOrder($order_id, $user_email)
  {
    ...
    // Create a message
    $message_client = (new Swift_Message("Вы совершили заказ №{$order_id}" ))
    ...
    $_SESSION['success'] = 'Спасибо за Ваш заказ. В ближайшее время С Вами свяжется наш менеджер для подтверждения заказа';
  }
